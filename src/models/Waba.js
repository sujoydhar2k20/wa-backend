...
const phoneNumberSchema = new mongoose.Schema({
  ...
  messagingLimitTier: { type: String, enum: ['TIER_1K', 'TIER_10K', 'TIER_100K', 'UNLIMITED', null], default: 'TIER_100K' },
  messagingLimit: { type: Number, default: 100000 }, // Resolved numeric limit from tier
}, { _id: false });
